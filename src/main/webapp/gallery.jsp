...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">  
	...
	<div class="gallery">
		<div class="container">
			<h2 class="heading-agileinfo">Gallery<span>Have a visit of Events covered by IBACK Events</span></h2>
			<div class="gallery-grids">
						...
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g2.jpg" data-lightbox="example-set" >
									...
									<figcaption>
										<p>Wadyanjalee 2016 , Organized by Viharamahadevi Balika, Kiribathgoda</p>
									</figcaption>	
								</a>
							</figure>
						</div>
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g3.jpg" data-lightbox="example-set" ><img src="images/g3.jpg" alt="" />
									<figcaption>
										<p>Anada Pahasaraniya 2016 Organized by Ananda College Colombo</p>
									</figcaption>		
								</a>
							</figure>
						</div>
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g4.jpg" data-lightbox="example-set" ><img src="images/g4.jpg" alt="" />
									<figcaption>
										<p>Anada Pahasaraniya 2018 Organized by Ananda College Colombo</p>
									</figcaption>	
								</a>
							</figure>
						</div>
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g5.jpg" data-lightbox="example-set" ><img src="images/g5.jpg" alt="" />
									<figcaption>
										<p>Anada Pahasaraniya 2018 Organized by Ananda College Colombo</p>
									</figcaption>	
								</a>
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g6.jpg" data-lightbox="example-set" ><img src="images/g6.jpg" alt="" />
									<figcaption>
										<p>Sara 18</p>
									</figcaption>		
								</a>
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g7.jpg" data-lightbox="example-set" ><img src="images/g7.jpg" alt="" /><figcaption>
										<p>Parade of the Legends 2016</p>
									</figcaption>	
								</a>
							</figure>
						</div>
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g8.jpg" data-lightbox="example-set" ><img src="images/g8.jpg" alt="" />
									<figcaption>
										<p>Arch Colored By Daddy</p>
									</figcaption>	
								</a>
							</figure>
						</div>
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="images/g9.jpg" data-lightbox="example-set" ><img src="images/g9.jpg" alt="" />
									<figcaption>
